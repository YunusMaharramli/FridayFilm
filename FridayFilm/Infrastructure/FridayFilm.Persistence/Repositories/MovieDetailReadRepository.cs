...
{
    public class MovieDetailReadRepository : ReadRepository<MovieDetail>, IMovieDetailReadRepository
    {
        public MovieDetailReadRepository(FridayFilmDbContext context) : base(context)
        {
        }
    }
}
